...
public class AccountsEditListFragment extends CSSListFragment implements /*OnQuitListener,*/ OnCheckedRowListener{
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		...
		//change by chw 20150909 将添加账号界面中的添加账号的加号删除
//		//添加账户
...
//                        MenuItem.SHOW_AS_ACTION_IF_ROOM );
        //end change by chw 20150909 将添加账号界面中的添加账号的加号删除
        ...
        //change by chw 20150909 将添加账号界面中的备份/恢复删除
//        //备份/恢复
...
//                    }
//                });
        //end change by chw 20150909 将添加账号界面中的备份/恢复删除
	...
	*/
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == Activity.RESULT_OK && data != null && data.getExtras() != null) {
		    ...
		    if(requestCode == CHOOSE_WIZARD) {		//选择SIP服务商会进入此处

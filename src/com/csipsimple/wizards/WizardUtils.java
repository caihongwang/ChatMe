...
//    				Basic.class));
			//change by chw 20150908 将Basic更改为Sip电信运营商
    		WIZARDS_DICT.put(BASIC_WIZARD_TAG, new WizardInfo(BASIC_WIZARD_TAG, "Sip电信运营商", 
    				R.drawable.ic_wizard_basic, 50, 
    				new Locale[] {}, true, false, 
    				Basic.class));
    		//end change by chw 20150908 将Basic更改为Sip电信运营商
		}
		//change by chw 20150908 将添加账号中的选择服务部分更改为只剩basic服务器
		//将com.csipsimple.wizards.impl包中删除只剩BaseImplementation.java Basic.java SimpleImplementation.java三个文件
...
//		}
//		initDone = true;
		//end change by chw 20150908 将添加账号中的选择服务部分更改为只剩basic服务器
	}
...
//		return R.drawable.ic_launcher_phone;
		return R.drawable.ic_launcher_nightly;
	}
